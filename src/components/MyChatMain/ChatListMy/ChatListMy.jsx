...
import scss from "./ChatListMy.module.scss";
...
import location_icon2 from "../../../assets/images/location_icon2.svg";
import message_icon from "../../../assets/images/message_icon.svg";
import ellipse from "../../../assets/images/ellipse.svg";
import strokes2 from "../../../assets/images/strokes2.svg";
    ...
    <div className={scss.chat__list}>
      ...
      <div className={scss.user_info}>
        ...
        <div className={scss.second_floor}>
          ...
          <Image src={location_icon2} alt="location_icon" />
          <p>{user_location}</p>
        </div>
        ...
        <div className={scss.strokes}>
          <Image src={strokes2} alt="strokes" />
        </div>
      </div>
    </div>
  );
